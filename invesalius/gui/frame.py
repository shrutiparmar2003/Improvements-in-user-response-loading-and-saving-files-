...
class ProgressDialog(wx.Dialog):
    def __init__(self, parent, title="Processing", message="Please wait..."):
        ...
        self.progress_bar = wx.Gauge(self, range=100, size=(300, 20))
        self.cancel_btn = wx.Button(self, label="Cancel")
        self.sizer.Add(self.message, 0, wx.ALL | wx.CENTER, 10)
        self.sizer.Add(self.progress_bar, 0, wx.ALL | wx.CENTER, 10)
        self.sizer.Add(self.cancel_btn, 0, wx.ALL | wx.CENTER, 10)
